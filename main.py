...
from resources import clock, background, background_music, game_over_sound, player_explosion_frames, screen, surface
...
def game_mechanics(asteroids, shots, player, scoreboard):
...
def game_loop(drawable, updatable, asteroids, shots, player, scoreboard):
    ...
    while not game_over:
        ...
        game_over, start_new_game = game_mechanics(asteroids, shots, player, scoreboard)    # Perform actual game mechaniscs
...
def main(): 
    ...
    while start_new_game:                                                                        
        ...
        start_new_game = game_loop(drawable, updatable, asteroids, shots, player, scoreboard)   # Start game loop
